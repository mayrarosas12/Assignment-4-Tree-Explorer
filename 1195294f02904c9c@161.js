...
require("d3@6")
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`# Trees
This is a map of the trees in Champaign, IL. The first map is a rotation of each individual point and the second map is a rotation of the entire map. The third map allows you to pan and zoom. The last map allows you to select multiple clusters of trees in a rectangular area and gives numeral information directly on the map.`
)});
  ...
  main.variable(observer()).define(["makeTrees","d3","trees"], function*(makeTrees,d3,trees)
{
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`# Parking Meters
This is a map of the parking meters in Champaign, IL. The first map is a rotation of the map. The second map allows you to pan and zoom. The third map gives you the address and hourly rate of the meter. The last map allows you to select multiple clusters of trees in a rectangular area and gives numeral information directly on the map.`
)});
